System.register(["@angular/router", "./login/login-form.component", "./dashboard/dashboard-form.component", "./usersList/users-list-form.component", "./_guards/auth.user-guard", "./_guards/auth.admin-guard"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, login_form_component_1, dashboard_form_component_1, users_list_form_component_1, auth_user_guard_1, auth_admin_guard_1, routes, AppRoutingModule;
    return {
        setters: [
            function (router_1_1) {
                router_1 = router_1_1;
