System.register(["@angular/platform-browser", "@angular/core", "@angular/forms", "@angular/http", "angular-confirmation-popover", "./app.component", "./app-routing.module", "./login/login-form.component", "./dashboard/dashboard-form.component", "./users/usersList/users-list-form.component", "./users/userForm/user-form.component", "./_guards/auth.user-guard", "./_guards/auth.admin-guard", "./_services/error-handler.service", "./_services/authentication.service", "./_services/user.service", "./errors/generic-error.component", "./errors/error-401.component", "./errors/error-401-token-expired.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var platform_browser_1, core_1, forms_1, http_1, angular_confirmation_popover_1, app_component_1, app_routing_module_1, login_form_component_1, dashboard_form_component_1, users_list_form_component_1, user_form_component_1, auth_user_guard_1, auth_admin_guard_1, error_handler_service_1, authentication_service_1, user_service_1, generic_error_component_1, error_401_component_1, error_401_token_expired_component_1, AppModule;
    return {
        setters: [
