System.register(["@angular/core", "@angular/router", "../_services/authentication.service"], function (exports_1, context_1) {
    ...
    var core_1, router_1, authentication_service_1, AuthAdminGuard;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            AuthAdminGuard = (function () {
                function AuthAdminGuard(router, authService) {
                    this.router = router;
            ...
            exports_1("AuthAdminGuard", AuthAdminGuard);
        }
    };
});
